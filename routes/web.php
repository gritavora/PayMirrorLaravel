...
Route::middleware(['web'])->group(function () {
    ...
    Route::middleware('auth')->group(function () {
        ...
        Route::post('/colaboradores/requerimentos/{id}/finalizar', [RequerimentoController::class, 'finalizar'])->name('colaboradores.requerimentos.finalizar');
    });
    ...
    // Rota para pontos de hora (Admin)
    ...
    Route::prefix('admin')->group(function () {
        ...
        Route::get('/requerimentos', [RequerimentoController::class, 'indexAdmin'])->name('admin.requerimentos');
        Route::get('/sobre-nos', [SobreNosController::class, 'index'])->name('admin.sobre-nos');

        // Rota para responder aos requerimentos
        Route::post('/requerimentos/{id}/responder', [RequerimentoController::class, 'responder'])->name('admin.requerimentos.responder');
    });

    // Rota para os requerimentos dos colaboradores
    Route::get('/colaboradores', function () {
    ...
    // Rota para o holerite do colaborador
